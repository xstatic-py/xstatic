...
project = "XStatic"
copyright = "2011-2026, Thomas Waldmann"
...
latex_documents = [
    ("index", "XStatic.tex", "XStatic Documentation", "Thomas Waldmann", "manual"),
]
...
man_pages = [("index", "xstatic", "XStatic Documentation", ["Thomas Waldmann"], 1)]
